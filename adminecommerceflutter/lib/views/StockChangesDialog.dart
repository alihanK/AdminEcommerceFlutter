...
class StockChangesDialog extends StatefulWidget {
  final Map<int, int> changedStocks;

  const StockChangesDialog({Key? key, required this.changedStocks})
      : super(key: key);

  @override
  State<StockChangesDialog> createState() => _StockChangesDialogState();
}

class _StockChangesDialogState extends State<StockChangesDialog> {
  ...
  Future<void> _applyChanges() async {
    final toConfirmIds = _selected.entries
